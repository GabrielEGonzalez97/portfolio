import { IProject, IPublicProject } from "@common/interfaces";
import { IBM_COMPANY } from "./companies.constants";
import {
  AI_AGENTS_SKILL,
  ANGULAR_SKILL,
  CARBON_SKILL,
...
export const PRIVATE_PROJECT_2024: IProject = {
...
export const PRIVATE_PROJECT_2023: IProject = {
  contribution:
...
export const CLARITY_PROJECT: IProject = {
  contribution:
...
export const EXACTAMENTE_PROJECT: IPublicProject = {
  name: 'Exactamente',
  shortDescription: 'Creator and maintainer of the website. The idea of the website is to provide a place where students can find tools and useful material to help them during their time at university.',
  extendedDescription: '',
  contribution: '',
  role: 'Software Engineer',
  duration: '',
...
export const SURFPHOTOS_PROJECT: IPublicProject = {
  name: 'SurfPhotos',
  shortDescription: 'Co-creator of the website. A website to showcase surfing photos taken by a photographer from the city where I am residing. The photos can be grouped into albums, and information is provided to contact the photographer.',
  extendedDescription: '',
  contribution: '',
  role: 'Software Engineer',
  duration: '',
